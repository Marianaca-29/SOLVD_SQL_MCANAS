...
-- TABLE 1 OF 13 
DROP TABLE IF EXISTS computer_service_repair;
CREATE TABLE IF NOT EXISTS computer_service_repair  (
-- columns
...
computer_service_repair_id INT NOT NULL,
invoice_id INT NOT NULL,
-- details of relations
primary KEY (id),
foreign KEY (invoice_id) references invoice(id) ON UPDATE CASCADE ON DELETE NO ACTION,
foreign KEY (computer_service_repair_id) references computer_service_repair(id)  ON UPDATE CASCADE ON DELETE NO ACTION
);
...
-- TABLE 15 intermediate table
CREATE TABLE IF NOT EXISTS device_has_customer (
-- columns
id INT NOT NULL,
...
-- details of relations
PRIMARY KEY (id),
FOREIGN KEY (iddevice)REFERENCES device(id) ON DELETE NO ACTION ON UPDATE NO ACTION,
FOREIGN KEY (idcustomer) REFERENCES customer(id) ON DELETE NO ACTION ON UPDATE NO ACTION
);

-- TABLE 16 intermediate table
...
PRIMARY KEY (id),
FOREIGN KEY (idcustomer) REFERENCES customer (id) ON DELETE NO ACTION ON UPDATE NO ACTION,
FOREIGN KEY (idinvoice) REFERENCES invoice(id) ON DELETE NO ACTION ON UPDATE NO ACTION
);
